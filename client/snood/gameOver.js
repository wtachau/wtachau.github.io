import {
  hideElementById, showElement, hideElement, showElementById
...
export const gameOverDisplay = (didWin, score, startGame) => {
  ...
  const flashMessage = (message) => {
    ...
    gameOverTextElement.style.left = (window.innerWidth - gameOverTextElement.clientWidth) / 2 + 'px'
  }
  flashMessage(didWin ? 'you won!!! <br><br>  your score: ' + score : 'whoops! you lost :(')
}
